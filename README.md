This is a project to create a simple board game in browser. It is strongly based upon 
https://github.com/fullstackreact/food-lookup-demo.git For context see also:
https://www.fullstackreact.com/articles/using-create-react-app-with-a-server/

fullstackreact/food-lookup-demo.git is based upon 
[create-react-app](https://github.com/facebookincubator/create-react-app). Most of the 
following text comes from the original README.md of fullstackreact/food-lookup-demo.
